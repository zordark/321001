...
namespace StepGame
{
    public partial class Form1 : Form
    {
        ...
        private void InitializePlayers()
        {
            ...
            user = new PlayerUser(pictureBox6, "Ежик", Weapon.Random());
            //players.Add( user );
            gameRunning = true;
            ...
            allplayers.Add(user);
            enemies.Add( new PlayerAI( pictureBox1,  "Крош",    Weapon.Random() ));
            enemies.Add(new PlayerAI(  pictureBox2,  "Копатыч", Weapon.Random()));
            enemies.Add(new PlayerAI(  pictureBox3,  "Карыч",   Weapon.Random()));
            enemies.Add(new PlayerAI(  pictureBox4,  "Лосяш",   Weapon.Random()));
            enemies.Add(new PlayerAI(  pictureBox5,  "Пин",     Weapon.Random()));
